...
## Project Structure
    ...
    ├── testapiautostoryboa_71110  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_71110`
...
2. Clone this repo and `cd testapiautostoryboa_71110`
